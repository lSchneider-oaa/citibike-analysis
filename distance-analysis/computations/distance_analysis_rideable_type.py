...
average_distances = df.groupby('rideable_type')['distance_km'].mean()

# Display the results
for bike_type, avg_distance in average_distances.items():
    print(f"The average distance for {bike_type} is {avg_distance:.2f} km.")
